@def title = "Learning Calculus"


### Math YouTube Channels that cover Calculus 
...
* [An Arbitrary Algebraist -- Calculus Playlist](https://www.youtube.com/playlist?list=PLdlilve4MNeikPgZI0kleRztmPwbCkKlv) 
  (this is my channel)

### Textbooks
If you're looking for a calculus textbook
for one of the following: 
* self studying
* a year-long high school class 
then check out
...
<!-- If you're looking for a book that is better suited
for a college class, maybe look at open stax -->
