@def title = "Why basic research is important"
@def rss_title = "Why basic research is important"
...
Ok, let's think about number theory, which is one of my areas of research.
A number theorist studies, well, numbers, but mostly we tend to study *prime numbers*--numbers that don't factor into a product of two other numbers 
($7$ is a prime number, $6 = 2 \cdot 3$ is not).

Here's an example of something you could try to do if you were a number theorist.
...
Luckily for Watanabe, he could ask [Morihiko Saito](https://en.wikipedia.org/wiki/Morihiko_Saito).
...
[^3]: Honestly, this probably would have been against Grothendieck's own wishes. He was a [radical pacifist](https://en.wikipedia.org/wiki/Alexander_Grothendieck#Political_activism), and retired from academic life when he realized his institute was funded by the military. He once gave math lectures in Vietnam next to a city that was being bombed in protest of the Vietnam war. 
